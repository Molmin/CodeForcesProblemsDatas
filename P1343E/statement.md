...
<p>One of the possible solution to the first test case of the example:</p><p><img class="tex-graphics" src="file://dnaC2yf8.png" style="max-width: 100.0%;max-height: 100.0%;"></p><p>One of the possible solution to the second test case of the example:</p><p><img class="tex-graphics" src="file://PAEzOoIq.png" style="max-width: 100.0%;max-height: 100.0%;"></p>

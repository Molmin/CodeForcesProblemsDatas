...
<p>Note that in every picture below the matrix is transformed in such a way that the blue rows are swapped with the green columns.</p><p>In the first test case, we can perform $1$ operation for $k = 3$. The matrix will be transformed as below: </p><center> <img class="tex-graphics" src="file://t4CP0XJ0.png" style="max-width: 100.0%;max-height: 100.0%;"> </center> In the second test case, we can perform $2$ operations for $k = 1$ and $k = 3$: <center> <img class="tex-graphics" src="file://Cjx41SRf.png" style="max-width: 100.0%;max-height: 100.0%;"> </center> <center> <img class="tex-graphics" src="file://Qd2ggNzP.png" style="max-width: 100.0%;max-height: 100.0%;"> </center>
